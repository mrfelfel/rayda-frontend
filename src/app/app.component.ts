    ...
    this.ngZone.runOutsideAngular(() => {
      ...
      this.router.events.subscribe(async (d) => {
        ...
        if ((this.showRoute === true) && (!this.Proutes) && (this.check === 0)) {
          this.check++;
          const eimg = `https://5bf3c8b2b293ba0012ce1945.storage.liara.ir/avatars/${this.uid}.png`;

          if (this.imageExists(eimg)) {

            this.imgprofile = eimg;
          }
